...
const legacyPhotoCopy = new Map([
  [1, { srcs: ['/images/photo-01.jpg', '/images/restored-photo-01.jpg'], caption: 'Upside-Down City', description: 'A narrow rain puddle turns the brick building across the street upside down, holding its windows and pointed roof inside a quiet strip of wet pavement.' }],
  [2, { srcs: ['/images/photo-02.jpg', '/images/restored-photo-02.jpg'], caption: 'One Line Above', description: 'A charcoal wall cuts diagonally across a bright cyan sky while a single white contrail passes overhead, reducing the scene to color, scale, and one precise line.' }],
  [3, { srcs: ['/images/photo-03.jpg', '/images/restored-photo-03.jpg'], caption: 'Red Towers, Blue Sky', description: 'Two reflective skyscrapers rise from opposite corners, their warm red grids framing a vivid opening of blue sky and drifting white clouds.' }],
  [4, { srcs: ['/images/photo-04.jpg', '/images/restored-photo-04.jpg'], caption: 'White Rhythm', description: 'Soft vertical folds move from shadow into light, transforming a simple white curtain into a quiet study of repetition, texture, and brightness.' }],
  [5, { srcs: ['/images/photo-05.jpg', '/images/restored-photo-05.jpg'], caption: 'Under the bridge', description: 'Shadows cast long and deep, hiding secrets beneath concrete and steel.' }],
  [6, { srcs: ['/images/photo-06.jpg', '/images/restored-photo-06.jpg'], caption: 'Open to sky', description: 'A rare clearing where the clouds gather, uninterrupted by the city below.' }],
]);
