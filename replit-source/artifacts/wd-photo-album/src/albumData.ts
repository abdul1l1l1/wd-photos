...
const legacyPhotoCopy = new Map([
  ...
  [6, { srcs: ['/images/photo-06.jpg', '/images/restored-photo-06.jpg', '/images/restored-photo-06-v2.jpg', '/images/photo-06-night-walk-pexels.jpg'], captions: ['Open to sky', 'Open Octagon'], descriptions: ['A rare clearing where the clouds gather, uninterrupted by the city below.', 'Dark structural beams form a precise octagonal frame around a bright opening, drawing the eye upward toward a clear and nearly featureless sky.', 'Two silhouettes walk down a wet wooden path toward a lively city intersection at night. Streetlights, headlights, and glowing windows gather around the dark figures, turning an ordinary walk into a quiet view of the city after sunset.', 'Two people walk toward the city on a rainy night.'] }],
  [7, { srcs: ['/images/photo-07.jpg'], captions: ['Lantern hour'], descriptions: ['Dusk settling in, warm glow illuminating the evening as the day winds down.', 'A lantern glows as the evening begins.'] }],
  [8, { srcs: ['/images/photo-08.jpg'], captions: ['Hard light'], descriptions: ['Sharp contrasts created by the unforgiving midday sun, highlighting every detail.', 'Bright sunlight cuts across the scene.'] }],
  [9, { srcs: ['/images/photo-09.jpg'], captions: ['Edge of water'], descriptions: ['Where the land meets the calm surface, reflecting the sky in a perfect mirror.', 'Calm water meets the edge of the land.'] }],
]);
