...
export const starterAlbum: Album = {
  ...
  photos: [
    ...
    { id: 3, src: '/images/restored-photo-03-v2.jpg', caption: 'Downtown San Diego', description: 'Downtown San Diego shifts between bright waterfront lights and the soft gray of the marine layer. High-rises, palm-lined streets, and wet pavement hold the city in a moody coastal atmosphere, whether the skyline is glowing after dark or disappearing into low clouds.' },
    { id: 4, src: '/images/restored-photo-04-v2.jpg', caption: 'Rainlit Drive', description: 'A night drive unfolds behind rain-streaked glass, with brake lights, streetlamps, and wet pavement dissolving into red and amber reflections. From the quiet passenger seat to the open road ahead, the city feels distant, enclosed, and slow.' },
    { id: 5, src: '/images/photo-05-v3.jpg', caption: 'I AM MUSIC', description: 'I AM MUSIC BY PLAYBOI CARTI' },
    { id: 6, src: '/images/photo-06-night-walk-pexels.jpg', caption: 'Night Walk', description: 'Two silhouettes walk down a wet wooden path toward a lively city intersection at night. Streetlights, headlights, and glowing windows gather around the dark figures, turning an ordinary walk into a quiet view of the city after sunset.' },
...
const legacyPhotoCopy = new Map([
  ...
  [2, { srcs: ['/images/photo-02.jpg', '/images/restored-photo-02.jpg', '/images/restored-photo-02-v2.jpg'], captions: ['One Line Above', 'Everyday Audio Kit'], descriptions: ['A charcoal wall cuts diagonally across a bright cyan sky while a single white contrail passes overhead, reducing the scene to color, scale, and one precise line.', 'Headphones, earbuds, charging cases, cables, and pocket-sized devices are arranged across dark fabric like the contents of a daily listening routine.', 'This collection of headphones, earbuds, cables, charging cases, and portable players represents several ways people listen to recorded audio. Wired equipment carries the signal through a physical connection, while wireless devices trade cables for rechargeable batteries and Bluetooth connectivity.'] }],
  ...
  [6, { srcs: ['/images/photo-06.jpg', '/images/restored-photo-06.jpg', '/images/restored-photo-06-v2.jpg'], captions: ['Open to sky', 'Open Octagon'], descriptions: ['A rare clearing where the clouds gather, uninterrupted by the city below.', 'Dark structural beams form a precise octagonal frame around a bright opening, drawing the eye upward toward a clear and nearly featureless sky.'] }],
]);
