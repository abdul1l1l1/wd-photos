...
const legacyPhotoCopy = new Map([
  ...
  [8, { srcs: ['/images/photo-08.jpg'], captions: ['Hard light'], descriptions: ['Sharp contrasts created by the unforgiving midday sun, highlighting every detail.'] }],
  [9, { srcs: ['/images/photo-09.jpg'], captions: ['Edge of water'], descriptions: ['Where the land meets the calm surface, reflecting the sky in a perfect mirror.'] }],
]);
